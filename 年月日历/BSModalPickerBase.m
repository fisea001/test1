...
#define kToolButtonTitleColor [UIColor colorWithRed:0.0/255.0 green:122.0/255.0 blue:255.0/255.0 alpha:1.0]
...
- (UIToolbar *)toolbar {
    if (!_toolbar) {
        ...
        [cancelButton setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:kToolButtonTitleColor,NSForegroundColorAttributeName, [UIFont systemFontOfSize:16],NSFontAttributeName,nil] forState:UIControlStateNormal];
        //  Create a title label to show on toolBar for the title you need.
       _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, _toolbar.frame.size.width-66-57.0-16, 44)];
        ...
        [doneButton setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:kToolButtonTitleColor,NSForegroundColorAttributeName, [UIFont systemFontOfSize:16],NSFontAttributeName,nil] forState:UIControlStateNormal];
...
- (void)presentInView:(UIView *)view withBlock:(BSModalPickerViewCallback)callback {
    ...
    [self.backdropView removeFromSuperview];
     ;
    self.panel = [[UIView alloc] initWithFrame:CGRectMake(0, self.bounds.size.height - BSMODALPICKER_PANEL_HEIGHT+53, self.bounds.size.width, BSMODALPICKER_PANEL_HEIGHT)];//+53是在真机(4s)上调试出来的，为什么+53是如何计算的？？，在模拟器上不要加53，而且只有datepicker才有这个bug
    ...
    [UIView animateWithDuration:0.25 delay:0
                     ...
                     animations:^{
                         ...
                         //self.backdropView.backgroundColor=[UIColor greenColor];
